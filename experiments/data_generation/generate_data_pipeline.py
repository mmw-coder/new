...
def main():
    ...
    # 1. Rollout Dexp
    run_step("experiments/data_generation/01_rollout_dexp.py", "Generating Dexp (Exploration Set)", [
    ...
    # 2. Build Dsimple
    run_step("experiments/data_generation/02_build_dsimple.py", "Generating Dsimple (Templates)", [
        "--dataset_json", args.gsm8k_file,
    ...
    # 5. Build Deff
    run_step("experiments/data_generation/05_build_deff.py", "Assembling Deff (Efficiency Set)", [
        "--dexp_file", dexp_file,
